...
def calculate_y(x_1, x_2, submit):
    ...
    #call model
    pickle_modle = pickle.load (open('sourceCode/lab1_CarPricePrediction.model','rb'))
    #do predict
    predicted_car_price1=pickle_modle.predict(sample)
    #log transform
    predicted_car_price=0
    predicted_car_price = np.exp (predicted_car_price1)
